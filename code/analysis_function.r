...
diag.coex <- function(folder="~/result/scenario1.1/", name="result_scenario1.1_", file_iterations="output_scenario1.1.csv",com= "poly", b=seq(0.7,0.5,-0.1), g=seq(0,0.1,0.05),
