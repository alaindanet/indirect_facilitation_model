...
#'  Model: Same as model with local competition with prop. of b reduction #'
#'###################################################################'
library(deSolve)

# TODO: modify expression of b decrease following Florian's proposition. I can find it in my labbook.
