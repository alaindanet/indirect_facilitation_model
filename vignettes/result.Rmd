...
contour_c_f <- cnp_cveg_f +
  clustering_contour(clust_scenar, x = del, y = f, z = clustering, nb_pts = 50, duplic = clust_type, colour = "black", breaks = c(.3, .4)) 
...
contour_qpn_f <- rho_qpn_f +
  clustering_contour(clust_np, x = del, y = f, z = qpn, nb_pts = 50, colour = "black", breaks = c(.25, .75)) 
