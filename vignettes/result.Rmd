...
plot_grid(state_u, clust_u, p_qpn_u, legend_qpn, labels = "AUTO", nrow = 1)
```
...
clustering_plot <- plot_grid(
  plot_grid(state_u,state_f, legend_state, ncol = 3, rel_widths = c(1, 1, .1)),
  plot_grid(plot_grid(c_del_u, c_del_f, nrow = 2), legend_clust, ncol = 2, rel_widths = c(1, .1)),
  plot_grid(p_qpn_u, p_qpn_f, legend_qpn, ncol = 3, rel_widths = c(1, 1, .1)),
  labels = "AUTO",
  ncol = 1,
  rel_heights = c(.5, 1, .5)
  )
