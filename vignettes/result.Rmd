...
b <- plot_diagram(filtered_scenar, param = c(x = "del", y = "u"), fill = "cnp")
...
a2 <- plot_diagram(states, param = c(x = "del", y = "u")) +
  xylabs(x = "del", y = "u") +
  theme_alain()
...
clust_data <- select(ungroup(b$data), u, del, cveg, cnp) %>%
...
b2 <- plot_diagram(clust_scenar, param = c(x = "del", y = "u"), fill =
  "clustering") + 
  theme_alain() +
  xylabs(x = "del", y = "u") +
  scale_fill_temperature(name = "Clustering") +
...
b2
c2 <- plot_diagram(clust_scenar, param = c(x = "del", y = "u"), fill = "cveg") +
  theme_alain() +
  xylabs(x = "del", y = "u") +
  scale_fill_temperature(name = "Clustering") 
...
plot_grid(a2, b2, labels = "AUTO", nrow = 2)
```
