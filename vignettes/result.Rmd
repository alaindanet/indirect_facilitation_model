...
states <- map(states, rm_y_axis)
states[[1]] <- states[[1]] +
  labs(title = "Strength of indirect facilitation (u)")
states[[2]] <- states[[2]] +
  labs(title = "Strength of direct facilitation (f)")
...
# Right column
list_of_plot <- list(states[[2]], clust_f[1, ]$interp[[1]],
