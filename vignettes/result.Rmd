...
b <- plot_diagram(compute_states(clust_avg), param = c(x = "del", y = "u"))
...
c1 <- plot_fig3bisbis(filtered_scenar, x = "del", y = "u", facet = "g")
...
filtered_scenar %<>% compute_states(.) 

d <- plot_diagram(filtered_scenar, param = c(x = "del", y = "u")) +
  theme_alain()

plot_grid(a, b, c1, d, labels = "AUTO")
```
